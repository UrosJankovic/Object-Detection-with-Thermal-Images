...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolov3-spp.pt', help='model.pt path(s)')
    parser.add_argument('--data', type=str, default='data/kaist.yaml', help='*.data path')
