...
def train(hyp, opt, device, tb_writer=None, wandb=None):
    ...
    if rank in [-1, 0] and wandb and wandb.run is None:
        ...
        wandb_run = wandb.init(config=opt, resume="allow",
                               project='YOLOv3-kaist-v028' if opt.project == 'runs/train' else Path(opt.project).stem,
                               name=save_dir.stem,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/kaist.yaml', help='data.yaml path')
